...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plataforma interna de gestão jurídica de clientes." },
      { property: "og:title", content: "Sistema Jurídico Interno" },
      { property: "og:description", content: "Plataforma interna de gestão jurídica de clientes." },
